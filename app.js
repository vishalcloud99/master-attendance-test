...
function renderHistory() {
    ...
    filtered.forEach(item => {
        let title = '', detail = '', badge = '', receiptBtn = '';
        ...
        if (currentHistoryType === 'visits') {
            ...
            detail = `${formattedDate} • ${item.purpose}`;
        ...
        const cardTimestamp = Utils.formatDateTime(item.date, item.time);
        ...
        html += `
            <div class="history-card">
                <div class="history-card-header">
                    <span>${cardTimestamp} -- Auto capture</span>
                    ${badge}
                </div>
